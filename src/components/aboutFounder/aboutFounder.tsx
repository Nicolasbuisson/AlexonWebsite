...
export const AboutFounder = () => {
  ...
  return (
    <section className="about-founder-section" ref={founderSectionRef}>
      ...
      <div className="about-founder-grid-container" ref={founderTextRef}>
        <h3>Founder</h3>
        <div className="about-founder-text-container">
          <h4>Alexandre Buisson</h4>
          <p>
            ...
            stories that connect them. Recognizing the power storytelling holds
            to shape perception, Alex later studied business at McGill
            University in Canada, where he developed a deep understanding of how
            digital marketing and content can drive real impact for brands.
          </p>
          <p>
            ...
            unnoticed—transforming the intangible into something tangible
